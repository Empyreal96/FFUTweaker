...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <mtbf:SectionsData xmlns:mtbf="null">
    <SectionData SectionNumber ="Telephony"/>
    <SectionData SectionNumber ="Messaging"/>
    <SectionData SectionNumber ="EMail"/>
    <SectionData SectionNumber ="Browser"/>
    <SectionData SectionNumber ="PIM"/>
    <SectionData SectionNumber ="Multimedia"/>
  </mtbf:SectionsData>
          ...
          <xsl:for-each select="Devices/Device">
            ...
            <li>
              <a id="detailed_report_tab_{$deviceIndex}" class="{$detailedReportTabClass}" href="javascript:switchToDeviceReport({$deviceIndex}, {$totalDeviceCount}, 'detailed_report_tab_', 'detailed_report_');">
                设备 <xsl:value-of select="$deviceIndex"/>
              </a>
            </li>
          </xsl:for-each>
        </ul>
                              ...
                              <xsl:variable name="logFile">
                                <xsl:for-each select="Logs/Log">
                                  <xsl:choose>
                                    ...
                                    <xsl:when test="contains(@FileName, '.log')">
